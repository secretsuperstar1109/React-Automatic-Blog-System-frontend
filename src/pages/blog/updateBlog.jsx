...
const UpdateBlog = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://os3-318-48579.vs.sakura.ne.jp/api/blog/${id}`
        );
  ...
  const handleSubmit = (e) => {
    ...
    console.log("show: ", show);
    axios
      .put(`https://os3-318-48579.vs.sakura.ne.jp/api/blog/${id}`, formData)
      .then((res) => {
        // setData({
        // 	post_date: "",
        // 	contributor: "",
  ...
  const handleDelete = () => {
    axios
      .delete(`https://os3-318-48579.vs.sakura.ne.jp/api/blog/${id}`)
      .then((res) => {
        console.log(res.data.message);
        navigate("/blog");
      })
