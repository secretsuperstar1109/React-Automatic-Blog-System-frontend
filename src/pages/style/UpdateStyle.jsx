...
const UpdateStyle = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://os3-318-48579.vs.sakura.ne.jp/api/style/${id}`
        );
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`https://os3-318-48579.vs.sakura.ne.jp/api/style/${id}`, formData)
      .then((res) => {
        // setData({
        // 	update_stop: false,
        // 	internal_memo: "",
  ...
  const handleDelete = () => {
    axios
      .delete(`https://os3-318-48579.vs.sakura.ne.jp/api/style/${id}`)
      .then((res) => {
        console.log(res.data.message);
        navigate("/home");
      })
